...
{
				assertNotNull("Problem in the Category", categoryDAO.gettingCategory(3));
}
...
{
			Category category = categoryDAO.gettingCategory(8);
...
public void updateCategoryTest()
{
			...
			category.setCategoryDescript("CostCutter");
